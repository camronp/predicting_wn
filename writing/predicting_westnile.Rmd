...
mosquito_data_avg <- mosquito_data %>%
  group_by(week, year) %>%
...
all_data <- full_join(final, storm_events)
...
tail(all_data)
#23 weeks 2016, t4 = 68.7, t2 = 70.47, precip = 0.059 --> pos prop = 0
...
#week 34, 2017 0.52 predict
# 72.1 t4, 74.7 t2, 0.078 precip
```
